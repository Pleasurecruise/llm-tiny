...
import torch
from llm_tiny.model import ModelArgs, Transformer
from llm_tiny.tokenizer import Tokenizer
import argparse

class TextGenerator:
    def __init__(self,
                 checkpoint='F:/datasets/AI-Modelscope/TinyStories/output/ckpt.pt',  # 模型检查点路径
                 tokenizer_model_path='F:/datasets/AI-Modelscope/TinyStories/tok4096.model',  # 分词器模型路径
...
if __name__ == "__main__":
    ...
    samples = generator.sample(start=args.prompt, num_samples=1, max_new_tokens=256)
