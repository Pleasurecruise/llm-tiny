...
from agent_tiny.llm import InternLM2Chat
from agent_tiny.tool import Tools
...
class Agent:
    ...
    """
    to build the response in prompt format
    """
    ...
    """
    here plugin is same to the tool
    process the targeted tool to finish the task
    """
